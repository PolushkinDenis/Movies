...
const Header: FC = () => {
  ...
  function handleOutsideClick(e: any) {
    if (
      ...
      e.target.closest(".headerTop__avatar")
    ) {
    ...
    } else if(e.target.closest(".headerTop__avatar")) {
      setTypeMouseOver("profile");
    }
  }
    ...
    <div>
      <header className="header">
		...
		c0-3.914,3.185-7.099,7.1-7.099s7.1,3.185,7.1,7.099v7.991c0,0.313,0.101,0.622,0.283,0.877l3.312,4.599H4.43z"
                ...
                <Link to={"/"}>
                  {
                    userEmail === '' ?
                      ...
                      <MyButton classes="nbl-button__onlyIcon headerTop__avatar-green">
                        {userEmail[0]}
                      </MyButton>
                  }
                </Link>
            ...
            {
              <HeaderDropdownBody
                classN={onMouseOverTogle ? "focusAnim" : "notFocusAnim"}
                type={typeMouseOver}
              ></HeaderDropdownBody>
            }
          </div>
