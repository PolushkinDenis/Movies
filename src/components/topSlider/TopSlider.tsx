...
const newFilmsData = [
  {
    ...
    imgHref:
      "https://thumbs.dfs.ivi.ru/storage33/contents/b/1/abbeaa2d5c95b43afa0f740e0d0e2a.png/604x406/?q=85",
            ...
            <div className="posterUprightBlock__nbl-poster">
              <div className="poster__imageWrapper">
                ...
                <div className="poster__placeNumber">
                  <img
                    className="poster__picture-number"
                    src={`https://solea-parent.dfs.ivi.ru/picture/bypass/number${
                      index + 1
                    }.svg`}
                  />
                </div>
